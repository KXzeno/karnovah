    ...
    isProfileDropdownOpen ? 'block' : 'hidden'}`}
      ...
      <div className="bg-[#2B2730] min-h-screen">
        ...
        <div className="container mx-auto max-w-max">
          ...
          <div className="md:grid md:grid-cols-3 columns-3 gap-x-[4rem]" id="features">

            <div className="features-box">
              <svg className="mx-auto" xmlns="http://www.w3.org/2000/svg" height="3em" viewBox="0 0 640 512">
            ...
            <div className="features-box">
              <svg className="inline-block" xmlns="http://www.w3.org/2000/svg" height="3em" viewBox="0 0 576 512">
                { /* Font Awesome Free 6.4.2 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2023 Fonticons, Inc. */ }
            ...
            <div className="features-box"> 
              <svg className="inline-block" xmlns="http://www.w3.org/2000/svg" height="3em" viewBox="0 0 640 512">
                { /* Font Awesome Free 6.4.2 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2023 Fonticons, Inc. */ } 
