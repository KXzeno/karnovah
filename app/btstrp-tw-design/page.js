        ...
        <div className="container mx-auto max-w-max">
          ...
          <div className="md:grid md:grid-cols-3 md:columns-3 gap-x-[4rem]" id="features">
            ...
            <div className="features-box">
              <svg className="mx-auto stroke-2 stroke-red-700 fill-black" xmlns="http://www.w3.org/2000/svg" height="3em" viewBox="0 0 640 512">
              ...
              <p>Your projects become my priority—no time left behind.</p>
            </div>

            <div className="features-box">
              <svg className="inline-block stroke-2 stroke-red-700 fill-black" xmlns="http://www.w3.org/2000/svg" height="3em" viewBox="0 0 576 512">
                { /* Font Awesome Free 6.4.2 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2023 Fonticons, Inc. */ }
              ...
              <p>I have your <i className="pr-[0.15625rem]">front</i> covered, as well as your <i>back</i>.</p>
            </div>

            <div className="features-box"> 
              <svg className="inline-block stroke-2 stroke-red-700 fill-black" xmlns="http://www.w3.org/2000/svg" height="3em" viewBox="0 0 640 512">
                { /* Font Awesome Free 6.4.2 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2023 Fonticons, Inc. */ } 
              ...
              <p>Latest and most effective technologies at your service.</p>
            </div>
